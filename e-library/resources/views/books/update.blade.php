        ...
        <div class="max-w-3xl mx-auto">
            <form action="{{ route('books.update', $book) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="bg-white rounded-md border border-gray-100 overflow-hidden">
                    <div class="p-6">
                        <h3 class="text-lg font-medium mb-6">Update Buku</h3>

                        <div class="mb-4">
                            <label for="title" class="block text-sm font-medium text-gray-700 mb-1">Judul Buku</label>
                            <input type="text" id="title" name="title" value="{{ old('title', $book->title) }}" placeholder="Masukkan judul buku" class="w-full px-3 py-2 text-sm border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-gray-200 @error('title') border-red-500 @enderror" required>
                            @error('title')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input type="text" id="author" name="author" value="{{ old('author', $book->author) }}" placeholder="Nama penulis" class="w-full px-3 py-2 text-sm border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-gray-200 @error('author') border-red-500 @enderror" required>
                                @error('author')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="text" id="publisher" name="publisher" value="{{ old('publisher', $book->publisher) }}" placeholder="Nama penerbit" class="w-full px-3 py-2 text-sm border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-gray-200 @error('publisher') border-red-500 @enderror">
                                @error('publisher')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                            <div>
                                <label for="publication" class="block text-sm font-medium text-gray-700 mb-1">Tahun Terbit</label>
                                <input type="number" id="publication" name="publication" value="{{ old('publication', $book->publication) }}" placeholder="YYYY" class="w-full px-3 py-2 text-sm border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-gray-200 @error('publication') border-red-500 @enderror">
                                @error('publication')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="text" id="isbn" name="isbn" value="{{ old('isbn', $book->isbn) }}" placeholder="ISBN number" class="w-full px-3 py-2 text-sm border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-gray-200 @error('isbn') border-red-500 @enderror">
                                @error('isbn')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description" name="description" rows="4" placeholder="Deskripsi buku" class="w-full px-3 py-2 text-sm border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-gray-200 @error('description') border-red-500 @enderror">{{ old('description', $book->description) }}</textarea>
                            @error('description')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex items-center gap-4">
                                <div class="w-24 h-32 bg-gray-50 border border-gray-200 rounded-md flex items-center justify-center overflow-hidden">
                                    @if($book->cover_image)
                    ...
                    <div class="p-6 border-t border-gray-100">
                        <h3 class="text-lg font-medium mb-6">Detail Tambahan</h3>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                <label for="pages" class="block text-sm font-medium text-gray-700 mb-1">Jumlah Halaman</label>
                                <input type="number" id="pages" name="pages" value="{{ old('pages', $book->pages) }}" placeholder="Jumlah halaman" class="w-full px-3 py-2 text-sm border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-gray-200 @error('pages') border-red-500 @enderror">
                                @error('pages')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="tags" name="tags" value="{{ old('tags', $book->tags) }}" placeholder="Masukkan tag yang dipisahkan koma" class="w-full px-3 py-2 text-sm border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-gray-200 @error('tags') border-red-500 @enderror">
                            @error('tags')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
